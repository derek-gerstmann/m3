...
friend class MTentry;
	...
	MTkey(MTobject& p_obj, const double p_rmin, const double p_rmax, const double p_distance=-maxDist(), const BOOL p_splitted=FALSE, const BOOL p_recomp=FALSE):
	...
	MTobject object() const { return obj; }
...
public:
	...
	MTobject& object() const { return Key()->obj; }
	double minradius() const { return Key()->rmin; }
	double maxradius() const { return Key()->rmax; }
	void setobject(const MTobject& o) { Key()->obj=o; }
